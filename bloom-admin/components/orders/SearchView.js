...
export default class SearchView extends Component {
  ...
  state2props(state){
    ...
    return {
      ...
      isOnlyBloom,
      isOnlyNotToPrint,
      createdFromDate:createdFromMoment?createdFromMoment.toDate():null,
      createdToDate:createdToMoment?createdToMoment.toDate():null,
      deliveryFromDate:deliveryFromMoment?deliveryFromMoment.toDate():null,
      deliveryToDate:deliveryToMoment?deliveryToMoment.toDate():null,
    };
